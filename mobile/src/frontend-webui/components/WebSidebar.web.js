...
const styles = StyleSheet.create({
  ...
  userName: { fontSize: 12.5, fontWeight: '800', color: '#ffffff' },
  userRole: { fontSize: 10, color: '#94a3b8', marginTop: 2, fontWeight: '600' },
  userCompany: { fontSize: 10.5, color: '#64748b', marginTop: 1 },
  ...
  menuIcon: { fontSize: 14, marginRight: 10 },
  menuLabel: { fontSize: 12.5, color: '#94a3b8', fontWeight: '600' },
  ...
  logoutIcon: { fontSize: 14, marginRight: 10 },
  logoutLabel: { fontSize: 12.5, color: '#f87171', fontWeight: '700' },
});
